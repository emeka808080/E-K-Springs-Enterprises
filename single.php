...
$page_column_class = druco_page_layout_columns_class($theme_options['ts_blog_details_layout'], $theme_options['ts_blog_details_left_sidebar'], $theme_options['ts_blog_details_right_sidebar']);

$show_breadcrumb = apply_filters('druco_show_breadcrumb_on_single_post', true);
			...
			<?php if( $theme_options['ts_blog_details_date'] || $theme_options['ts_blog_details_author'] || $theme_options['ts_blog_details_comment'] || $theme_options['ts_blog_details_categories'] ) : ?>
				<div class="entry-meta-top">
					...
					<span class="comment-count">
						<?php
						$comment_count = druco_get_post_comment_count();
						echo sprintf( _n('%d comment', '%d comments', $comment_count, 'druco'), $comment_count );
						?>
					</span>
					<?php endif; ?>
	...
	<div class="entry-author-wrapper">
		<div class="entry-author">
			...
			<div class="author-info">		
				...
				<span class="role"><?php echo druco_get_user_role( get_the_author_meta('ID') ); ?></span>
