<?php 
global $post;
$blog_thumb_size = 'druco_blog_thumb';
...
?>
	<div class="ts-blogs ts-shortcode related-posts related ts-slider <?php echo esc_attr($is_slider?'loading':''); ?>">
		<header class="theme-title">
			<h3 class="heading-title"><?php esc_html_e('Related posts', 'druco'); ?></h3>
		</header>
				...
				<article class="item <?php echo esc_attr($post_format); ?> <?php echo has_post_thumbnail()?'has-post-thumbnail':'';?>">
					<div class="article-content">
						...
						<div class="entry-content <?php echo !$show_thumbnail?'no-featured-image':'' ?>">
							...
							<div class="excerpt"><?php druco_the_excerpt_max_words(14, '', true, '', true); ?></div>
							
							<!-- Blog Read More Button -->
							<div class="entry-meta-bottom">
								<a class="button-readmore button" href="<?php the_permalink() ; ?>"><?php esc_html_e('Read more', 'druco'); ?></a>
							</div>
