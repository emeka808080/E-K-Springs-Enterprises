		...
		<div class="header-template">
			...
			<div class="header-sticky">
				...
				<div class="header-bottom hidden-phone">
					<div class="container">
						<?php if( isset( $druco_theme_options['ts_attributes_form_search'] ) && array_filter( $druco_theme_options['ts_attributes_form_search'] ) && $druco_theme_options['ts_heading_form_search'] && function_exists('ts_form_product_filter_by_attribute') ): ?>
						<div class="attribute-search-wrapper">	
							<div class="attribute-search-heading">	
							<?php echo esc_html( $druco_theme_options['ts_heading_form_search'] ); ?>
							</div>
							<div class="attribute-search-form">
								<?php ts_form_product_filter_by_attribute( array_filter( $druco_theme_options['ts_attributes_form_search'] ) ); ?>
							</div>
						</div>
						<?php endif; ?>
