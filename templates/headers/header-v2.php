...
<header class="ts-header <?php echo esc_attr(implode(' ', $header_classes)); ?>">
	<div class="header-container">
		<div class="header-template">
			...
			<?php if( $druco_theme_options['ts_header_contact_info'] || $druco_theme_options['ts_header_store_notice'] || $druco_theme_options['ts_header_currency'] || $druco_theme_options['ts_header_language'] ): ?>
			...
			<div class="header-sticky">
				<div class="header-middle">
					<div class="container">
						...
						<?php if( $druco_theme_options['ts_header_contact_info'] ): ?>
						<div class="header-contact-info hidden-ipad"><?php echo wp_kses($druco_theme_options['ts_header_contact_info'], 'druco_header_text'); ?></div>
						<?php endif; ?>
