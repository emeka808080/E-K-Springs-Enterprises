...
<header class="ts-header <?php echo esc_attr(implode(' ', $header_classes)); ?>">
	<div class="header-container">
		<div class="header-template">
			...
			<?php if( $druco_theme_options['ts_header_contact_info'] || $druco_theme_options['ts_header_delivery_note'] || $druco_theme_options['ts_header_store_notice'] || has_nav_menu( 'top_header' ) ): ?>
